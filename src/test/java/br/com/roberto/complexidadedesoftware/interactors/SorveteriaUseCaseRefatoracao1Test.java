...
class SorveteriaUseCaseRefatoracao1Test {

    private SorveteriaUseCaseRefatoracao1 sorveteriaUseCase;
    private Boolean VALOR_NULO_BOLEANO_PARA_OBJETO = null;

    @BeforeEach
    void setup(){
        sorveteriaUseCase = new SorveteriaUseCaseRefatoracao1();
    }
    @Test
    ...
    void deveRetornarOValorDeUmSorveteSimplesSemCasquinhaSemCobertura() {
        Assertions.assertEquals(new BigDecimal(16), sorveteriaUseCase.getPrecoSorvete(false,false,0));
    }
